...
export const DEFAULT_SITE_CONTENT: SiteContent = {
  ...
  footer: { tagline: 'Original Tattoos. Lasting Stories.', copyright: '© 2026 Kevin Inks ● Original artwork only', locationLine: 'Houndstooth Tattoo Studio — By Appointment — Las Vegas, NV', designerLabel: 'Plexura', designerUrl: 'https://plexura.net' },
  contact: CONTACT,
}
